...
产物写到仓库根目录 market_data_today.json（已 gitignore）。
"""
...
DEFAULT_OUT = REPO_ROOT / "market_data_today.json"
...
if __name__ == "__main__":
    ...
    DEFAULT_OUT.write_text(json.dumps(data, ensure_ascii=False, indent=2), encoding="utf-8")

    print("\n" + "=" * 60)
    print(f"数据已保存到: {DEFAULT_OUT}")
    print("下一步: python skills/market-recap/scripts/generate_recap_stub.py")
    print("=" * 60)
